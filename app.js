...
const labelIconMap = {
  "こんにちは": "🙋", "ありがとう": "😊", "ごめんね": "🙇", "だいじょうぶ": "👌", "わかった": "💡",
  "わからない": "❓", "いやです": "🙅", "いいです": "⭕", "これ": "👇", "それ": "👉", "あれ": "☝️",
  "こっち": "⬅️", "あっち": "➡️", "どこ": "🗺️", "だれ": "👤", "なに": "❔", "いつ": "🕒",
  "いっしょに": "🤝", "ひとりで": "🧍", "ゆっくり": "🐢", "はやく": "💨", "ちょっとまって": "✋",
  "もうすこし": "🤏", "できた": "✅", "できない": "❌", "かして": "🤲", "どうぞ": "🫴", "みせて": "👀",
  "きいて": "👂", "よんで": "📣", "あけて": "🔓", "しめて": "🔒", "とって": "🖐️", "おいて": "📥",
  "やめて": "🛑", "はじめる": "▶️", "つぎ": "⏭️", "まえ": "⏮️", "おなじ": "🟰", "だいすき": "💖",
  "きらい": "💔", "えらぶ": "☑️", "これがいい": "👍", "もういらない": "🚫", "おねがい": "🙏",
  "さがす": "🔍", "なくした": "🫥", "みつけた": "✨", "おしえて": "🧑‍🏫", "つかう": "🛠️",

  "おにぎり": "🍙", "みそしる": "🥣", "うどん": "🍜", "そば": "🍜", "ラーメン": "🍜", "スパゲッティ": "🍝",
  "ピザ": "🍕", "ハンバーグ": "🍔", "からあげ": "🍗", "ポテト": "🍟", "サラダ": "🥗", "トマト": "🍅",
  "にんじん": "🥕", "きゅうり": "🥒", "とうもろこし": "🌽", "いちご": "🍓", "みかん": "🍊", "ぶどう": "🍇",
  "もも": "🍑", "なし": "🍐", "ヨーグルト": "🥛", "チーズ": "🧀", "プリン": "🍮", "ゼリー": "🍮",
  "ケーキ": "🍰", "チョコ": "🍫", "せんべい": "🍘", "クッキー": "🍪", "ドーナツ": "🍩", "ホットケーキ": "🥞",
  "おもち": "⚪", "のり": "🟩", "ふりかけ": "🧂", "納豆": "🫘", "豆腐": "⬜", "コロッケ": "🟤",
  "ぎょうざ": "🥟", "しゅうまい": "🥟", "ハム": "🥓", "ソーセージ": "🌭", "えび": "🦐", "かに": "🦀",
  "ツナ": "🐟", "パンケーキ": "🥞", "シリアル": "🥣", "サンドイッチ": "🥪", "お弁当": "🍱",
  "おかわり": "➕", "小さいごはん": "🍚", "大きいごはん": "🍚",

  "むぎちゃ": "🍵", "ココア": "☕", "カルピス": "🥛", "りんごジュース": "🧃", "オレンジジュース": "🧃",
  "ぶどうジュース": "🧃", "炭酸": "🥤", "お湯": "♨️", "冷たい水": "🧊", "あたたかいお茶": "🍵",
  "みそ汁": "🥣", "牛乳少し": "🥛", "牛乳たくさん": "🥛", "飲みたい": "🥤", "いらない": "🚫",
  "ストロー": "🥤", "コップ": "🥛", "ペットボトル": "🧴", "水筒": "🍶", "氷": "🧊",
  "ホットミルク": "🥛", "豆乳": "🥛", "飲むヨーグルト": "🥛", "薬の水": "💊", "うがい水": "🚰",
  "給食の牛乳": "🥛", "朝の水": "🌅", "寝る前の水": "🌙", "休み時間の水": "⏰", "もう一口": "🥄",
  "半分": "◐", "全部": "●", "冷まして": "🌬️", "こぼれた": "💧", "ふいて": "🧻", "入れて": "⬇️",
  "少なく": "🤏", "多く": "➕", "おかわり飲み物": "🥤", "飲み終わり": "✅", "スプーンで飲む": "🥄",
  "水分補給": "🚰", "甘い飲み物": "🍯", "すっぱい飲み物": "🍋", "ぬるい": "🌡️", "あつい飲み物": "☕",
  "飲めた": "✅", "飲めない": "❌", "持ってきて": "🫴", "片づける": "🧺",

  "ぬいぐるみ": "🧸", "人形": "🪆", "ミニカー": "🚗", "プラレール": "🚃", "レゴ": "🧱", "積み木": "🧱",
  "ままごと": "🍳", "粘土": "🟫", "お絵かき": "🎨", "折り紙": "🔺", "シール": "🏷️", "カード": "🃏",
  "ゲーム": "🎮", "動画": "▶️", "テレビ": "📺", "リモコン": "🎛️", "風船": "🎈", "シャボン玉": "🫧",
  "砂場": "🏖️", "すべり台": "🛝", "ブランコ": "🌳", "自転車": "🚲", "三輪車": "🚲", "縄跳び": "➰",
  "楽器": "🎹", "太鼓": "🥁", "ピアノ": "🎹", "マイク": "🎤", "ライト": "💡", "水遊び": "💦",
  "プール": "🏊", "電車遊び": "🚃", "道路遊び": "🛣️", "お医者さんごっこ": "🩺", "お店屋さん": "🏪",
  "迷路": "🌀", "図鑑": "📚", "しかけ絵本": "📖", "電池": "🔋", "充電": "🔌", "順番": "🔢",
  "交代": "🔄", "一緒に遊ぶ": "🤝", "一人で遊ぶ": "🧍", "壊れた": "🧩", "直して": "🛠️",
  "もう一回遊ぶ": "🔁", "終わりにする": "🏁",

  "見る": "👀", "話す": "🗣️", "歌う": "🎤", "踊る": "💃", "作る": "🛠️", "切る": "✂️", "貼る": "🩹",
  "塗る": "🖍️", "消す": "🧽", "開ける": "🔓", "閉める": "🔒", "入れる": "📥", "出す": "📤",
  "持つ": "✋", "運ぶ": "📦", "探す": "🔍", "選ぶ": "☑️", "並べる": "📊", "洗う": "🧼", "拭く": "🧻",
  "着る": "👕", "脱ぐ": "🧺", "履く": "👟", "かぶる": "🧢", "押す": "👇", "引く": "↩️", "投げる": "⚾",
  "取る": "🤏", "渡す": "🫴", "止まる": "🛑", "歩く": "🚶", "登る": "🧗", "降りる": "⬇️",
  "乗る": "🚌", "降りる車": "🚗", "笑う": "😄", "泣く": "😢", "怒る": "😠", "休む": "🛋️",
  "頑張る": "💪", "練習する": "📝", "勉強する": "📚", "質問する": "❓", "答える": "💬", "呼ぶ": "📣",
  "集まる": "👥", "離れる": "↔️", "帰る": "🏠",

  "ぼく": "👦", "わたし": "🙂", "あなた": "👉", "家族": "👪", "お兄ちゃん": "👦", "お姉ちゃん": "👧",
  "弟": "🧒", "妹": "👧", "赤ちゃん": "👶", "保育士さん": "🧑‍🏫", "支援員さん": "🤝", "看護師さん": "🧑‍⚕️",
  "店員さん": "🧑‍💼", "運転手さん": "🧑‍✈️", "警察官": "👮", "消防士": "🧑‍🚒", "近所の人": "🏘️",
  "お客さん": "🧑", "クラスの子": "👥", "男の子": "👦", "女の子": "👧", "大人": "🧑", "子ども": "🧒",
  "みんな": "👥", "誰か": "👤", "一人": "🧍", "二人": "👥", "グループ": "👨‍👩‍👧", "先生に言う": "🧑‍🏫",
  "お母さんに言う": "👩", "お父さんに言う": "👨", "友達に言う": "🧑‍🤝‍🧑", "助ける人": "🤝",
  "遊ぶ人": "🎈", "待つ人": "⏳", "迎えに来る人": "🚗", "送る人": "🚙", "好きな人": "💖",
  "苦手な人": "↔️", "療育の先生": "🧑‍🏫", "学校の先生": "🏫", "園の先生": "🏡", "祖父母": "👵",
  "親戚": "👪", "お医者さんに相談": "🧑‍⚕️", "係の人": "🧑‍💼", "受付の人": "🛎️", "知らない人": "❔",
  "いつもの人": "😊",

  "教室": "🏫", "廊下": "🚪", "玄関": "🚪", "台所": "🍳", "リビング": "🛋️", "寝室": "🛏️",
  "洗面所": "🚰", "お風呂場": "🛁", "庭": "🌳", "ベランダ": "🏡", "スーパー": "🛒", "コンビニ": "🏪",
  "薬局": "💊", "療育": "🧩", "児童館": "🏠", "図書室": "📚", "体育館": "🏀", "駐車場": "🅿️",
  "公民館": "🏛️", "レストラン": "🍽️", "カフェ": "☕", "公園のトイレ": "🚻", "遊具": "🛝",
  "ベンチ": "🪑", "家に帰る": "🏠", "学校に行く": "🏫", "外": "🌤️", "中": "🏠", "上": "⬆️",
  "下": "⬇️", "前": "⬆️", "後ろ": "⬇️", "右": "➡️", "左": "⬅️", "近く": "📍", "遠く": "🗺️",
  "静かな場所": "🤫", "休む場所": "🛋️", "待つ場所": "⏳", "集合場所": "👥", "入口": "🚪", "出口": "🚪",

  "起きる": "🌅", "朝ごはん": "🍚", "登園": "🎒", "登校": "🏫", "朝の会": "☀️", "自由遊び": "🎈",
  "制作": "🎨", "運動": "🏃", "給食": "🍱", "昼ごはん": "🍽️", "昼寝": "🛏️", "帰りの会": "🏁",
  "お迎え": "🚗", "宿題": "✏️", "おやつ": "🍪", "テレビ時間": "📺", "晩ごはん": "🍽️", "寝る準備": "🌙",
  "明日": "➡️", "今日": "📅", "昨日": "⬅️", "午前": "☀️", "午後": "🌇", "土曜日": "🟦",
  "日曜日": "☀️", "病院の日": "🏥", "歯医者の日": "🦷", "買い物": "🛒", "散歩": "🚶", "外遊び": "🌳",
  "雨の日": "☔", "晴れの日": "☀️", "イベント": "🎉", "誕生日": "🎂", "休みの日": "🛋️", "出発": "🚗",
  "到着": "🏁", "待ち時間": "⏳", "終わりの時間": "🏁", "次の予定": "⏭️", "変更": "🔄", "中止": "🛑",
  "もうすぐ": "⏰", "あとで": "⏲️", "今": "📍",

  "顔を洗う": "🚰", "うがい": "🚰", "鼻をかむ": "🤧", "爪切り": "✂️", "髪をとかす": "💇",
  "服を選ぶ": "👕", "ズボン": "👖", "靴下": "🧦", "上着": "🧥", "帽子": "🧢", "手袋": "🧤",
  "ハンカチ": "⬜", "ティッシュ": "🧻", "水筒を持つ": "🍶", "連絡帳": "📓", "靴を履く": "👟",
  "靴を脱ぐ": "👟", "かばんを置く": "🎒", "かばんを持つ": "🎒", "手を拭く": "🧻", "汗を拭く": "💦",
  "着替えを入れる": "👕", "洗濯に出す": "🧺", "パジャマ": "🛌", "オムツ": "🩲", "パンツ": "🩲",
  "トイレットペーパー": "🧻", "流す": "🚽", "手洗い場": "🚰", "消毒": "🧴", "体温を測る": "🌡️",
  "薬を飲む": "💊", "目薬": "👁️", "絆創膏": "🩹", "冷やす": "🧊", "温める": "♨️",
  "休憩する": "🛋️", "水を飲む": "🥤", "姿勢を直す": "🪑", "椅子に座る": "🪑", "机を拭く": "🧽",
  "ゴミを捨てる": "🗑️", "食器を下げる": "🍽️", "口を拭く": "🧻", "エプロン": "🥼", "スプーン": "🥄",
  "フォーク": "🍴", "箸": "🥢", "準備する": "📦",

  "びっくり": "😲", "ドキドキ": "💓", "不安": "😟", "安心": "😌", "さみしい": "🥺", "恥ずかしい": "😳",
  "くやしい": "😣", "わくわく": "🤩", "落ち着く": "😌", "落ち着かない": "😵‍💫", "うるさい": "🔊",
  "静かがいい": "🤫", "まぶしい": "☀️", "暗い": "🌙", "かゆい": "🫳", "気持ち悪い": "🤢",
  "お腹すいた": "🍽️", "のどかわいた": "🥤", "眠れない": "🌙", "やりたい": "🙋", "やりたくない": "🙅",
  "困った": "😟", "助かった": "😊", "わからなくて不安": "❓", "できてうれしい": "✅", "失敗した": "💦",
  "もう大丈夫": "👌", "まだ無理": "✋", "休みたい": "🛋️", "一人がいい": "🧍", "一緒がいい": "🤝",
  "抱っこして": "🫂", "離れて": "↔️", "近い": "📍", "遠い": "🗺️", "大きい音がいや": "🔊",
  "人が多い": "👥", "暑すぎる": "🥵", "寒すぎる": "🥶", "疲れすぎた": "😴", "楽しかった": "😄",
  "嫌だった": "😣", "心配": "😟", "平気": "👌", "怖くない": "🙂", "頑張った": "💪", "ほっとした": "😌",

  "顔": "🙂", "首": "🧣", "肩": "💪", "腕": "💪", "ひじ": "💪", "指": "☝️", "爪": "💅",
  "背中": "🧍", "胸": "🫀", "腰": "🧍", "おしり": "🧍", "ひざ": "🦵", "すね": "🦵",
  "かかと": "🦶", "つま先": "🦶", "鼻": "👃", "ほっぺ": "🙂", "あご": "🙂", "舌": "👅",
  "のど": "🗣️", "髪": "💇", "おでこ": "🙂", "まゆげ": "🙂", "まつげ": "👁️", "耳たぶ": "👂",
  "手首": "✋", "足首": "🦶", "おへそ": "🧍", "皮膚": "🖐️", "骨": "🦴", "筋肉": "💪",
  "心臓": "🫀", "息": "🌬️", "体": "🧍", "右手": "🤚", "左手": "✋", "右足": "🦶",
  "左足": "🦶", "上の歯": "🦷", "下の歯": "🦷", "目が痛い": "👁️", "耳が痛い": "👂",
  "お腹が痛い": "🧍", "頭が痛い": "🙂", "足が痛い": "🦶", "手が痛い": "✋", "かゆい所": "🖐️",
  "ぶつけた所": "💥", "けが": "🩹", "熱い所": "♨️",

  "受付": "🛎️", "待合室": "🪑", "診察": "🩺", "先生に見せる": "🧑‍⚕️", "聴診器": "🩺",
  "体温計": "🌡️", "血圧": "🫀", "検尿": "🧪", "レントゲン": "🩻", "吸入": "😮‍💨",
  "点滴": "💧", "消毒": "🧴", "包帯": "🩹", "湿布": "🩹", "塗り薬": "🧴", "飲み薬": "💊",
  "粉薬": "💊", "シロップ": "🧪", "診察券": "💳", "保険証": "💳", "予約": "📅", "呼ばれる": "📣",
  "口を開ける": "👄", "あーん": "👄", "歯を見る": "🦷", "削る音": "🔊", "虫歯": "🦷",
  "歯ブラシ": "🪥", "フッ素": "🦷", "耳鼻科": "👂", "眼科": "👁️", "皮膚科": "🖐️",
  "小児科": "🏥", "リハビリ": "💪", "検査結果": "📋", "痛くない": "🙂", "少し痛い": "😣",
  "終わった": "✅", "マスク": "😷", "咳が出る": "🤧", "鼻水": "🤧", "お腹が痛い": "🧍"
};

function getCardIcon(label, category) {
  if (labelIconMap[label]) return labelIconMap[label];
  if (label.includes("水") || label.includes("飲")) return "🥤";
  if (label.includes("ごはん") || label.includes("食")) return "🍽️";
  if (label.includes("痛")) return "🩹";
  if (label.includes("歯")) return "🦷";
  if (label.includes("手")) return "✋";
  if (label.includes("足")) return "🦶";
  if (label.includes("先生")) return "🧑‍🏫";
  if (label.includes("病院")) return "🏥";
  if (label.includes("遊")) return "🎈";
  if (label.includes("待")) return "⏳";
  ...
  return Object.entries(cardPools).flatMap(([category, labels]) => {
    ...
    return labels
      ...
      .map((label, index) => ({
        ...
        label,
        speech: label,
        icon: getCardIcon(label, category),
      }));
  });
}
